  ...
  return (
    <SectionLayout className="about-me">
        ...
        <div className="about-me__text-info">
          <div>
            ...
            <p className="about-me__info-long">
              Мой родной город Кемерово, но последние 10 лет я жил в Новосибирском Академгородке, где занимался наукой. В
              какой-то момент я понял, что хочу развиваться в другом направлении, и стал разработчиком интерфейсов.
      ...
      <div className="about-me__portfolio">
        ...
        <PortfolioLink label={'Статичный сайт'} linkURL={'#'}/>
        <PortfolioLink label={'Адаптивный сайт'} linkURL={'#'}/>
        <PortfolioLink label={'Одностраничное приложение'} linkURL={'#'}/>
      </div>
    </SectionLayout>
  )
}
